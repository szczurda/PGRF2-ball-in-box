...
OGLBuffers buffers;
	...
	public void init() {
		...
		shaderProgram = ShaderUtils.loadProgram("/lvl2advanced/p06compute/p03texture/drawImage");
		computeShaderProgram = ShaderUtils.loadProgram(null, null, null, null, null, 
				"/lvl2advanced/p06compute/p03texture/computeTexture"); 
		...
		try {
			...
			texture2 = new OGLTexture2D("textures/bricksn.png");
		} catch (IOException e) {
	...
	public void display() {
		...
		glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA32F, tex_w,
				tex_h, 0, GL_RGBA, GL_FLOAT, (FloatBuffer) null);
